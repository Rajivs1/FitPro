  ...
  return (
    <div className='flex items-center px-10 md:px-20 py-10 md:pt-0 md:pb-5 bg-slate-900'>
      <div className='w-full md:w-1/2 md:mt-16'>
        ...
        <p className='text-center sm:text-start text-slate-300 text-xs sm:text-sm xl:text-lg p-5 font-medium italic capitalize'>fuel your fitness revolution with FITPro..</p>
